...
public class DynamicEntitiesAssemblyBuilderTests
{
    [Fact]
    public void BuildCompilation_ShouldBuildNamespaceClassFromSimpleEntityTypeObject()
    {
        var @namespace = "TestNamespace";
        var builder = new DynamicEntitiesAssemblyBuilder(@namespace);
