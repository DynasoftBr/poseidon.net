    ...
    public class DynamicEntitiesAssemblyBuilder
    {
        ...
        public CSharpCompilation BuildCompilation()
        {
            ...
            this.@namespace = this.@namespace.AddUsings(
                ...
                SyntaxFactory.UsingDirective(SyntaxFactory.ParseName(typeof(Entity<>).Namespace!))
            );
